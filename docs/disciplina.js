            ...
            '<div class="card-block p-2">' +
                '<div class="row text-center text-capitalize">' +
                    '<span class="col-lg-10 row mx-auto">'+
                        '<p class="card-text col-   ">'+pageContent.content[count][indexDisciplina].body.theme1+'</p>'+
                        '<p class="card-text col-sm">'+pageContent.content[count][indexDisciplina].body.theme2+'</p>'+
                        '<p class="card-text col-sm">'+pageContent.content[count][indexDisciplina].body.theme3+'</p>'+
                        '<p class="card-text col-sm">'+pageContent.content[count][indexDisciplina].body.theme4+'</p>'+
                        '<p class="card-text col-sm">'+pageContent.content[count][indexDisciplina].body.theme5+'</p>'+
                        '<p class="card-text col-sm">'+pageContent.content[count][indexDisciplina].body.theme6+'</p>'+
                        '<p class="card-text col-sm">'+pageContent.content[count][indexDisciplina].body.theme7+'</p>'+
                        '<p class="card-text col-sm">'+pageContent.content[count][indexDisciplina].body.theme8+'</p>'+
                    '</span>' +
                    '<div class="col-lg-2">' +
                        '<p><button class="btn btn-secondary mt-2" type="button" data-toggle="collapse" data-target="#collapse' + indexDisciplina + '" aria-expanded="false"aria-controls="collapseExample">Saiba mais...</button></p>' +
                    '</div>' +
                '</div>' +
                '<div class="collapse p-2" id="collapse' + indexDisciplina + '">'+
        ...
        [  // Primeiro Semestre
            {
                ...
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NC",
                    "theme2": "<b>Teórica</b> <br>32",
                    "theme3": "<b>Prática</b> <br>0",
                    "theme4": "<b>Total</b> <br>32",
                    "theme5": "<b>Período</b> <br>1º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Nenhum",
                },
                "subtitle": "Ementa",
                ...
                "bibliografia": "FONSECA FILHO, C. História da computação: O Caminho do Pensamento e da Tecnologia. Porto Alegre: EDIPUCRS, 2007.<br>" +
                    "MASIERO, P. Ética em Computação. Editora da USP, 2000.<br>" +
                    "VELOSO, R. Tecnologias da Informação e Comunicação: Desafios e Perspectivas. São Paulo: Saraiva, 2011.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "CHALITA, G. Os Dez Mandamentos da Ética. Editora Nova Fronteira, 2003.<br>" +
                    "DRUMMOND, V. Internet, Privacidade e Dados Pessoais. Editora Lumen Juris, 2003.<br>" +
                    "KACZMARCZYK, L. C. Computers and Society: Computing for Good. Chapman & Hall/CRC Textbooks in Computing. CRC Press, 2011.<br>" +
                    "LUCCA, N.; FILHO, A. S. Direito & Internet. Editora Edipro, 2001.<br>" +
                    "PAESANI, L. M. Direito de Informática. Editora Atlas, 2005.<br>"
            },
            {
                "title": "Introdução à Programação",
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NC",
                    "theme2": "<b>Teórica</b> <br>48",
                    "theme3": "<b>Prática</b> <br>80",
                    "theme4": "<b>Total</b> <br>128",
                    "theme5": "<b>Período</b> <br>1º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Nenhum",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "FOBERLONE, A. L. V.; EBERSPACHER, H. F. Lógica de Programação: A construção de algoritmos e estruturas de dados. 3.a edição. São Paulo: Prentice Hall, 2005.<br>" +
                    "ASCENCIO, A. F. G.; CAMPOS, E. A. V. Fundamentos da Programação de Computadores. 3.a edição. Editora Pearson, 2010. <br>" +
                    "SCHILDT, H. C Completo e Total. 3a Ed.  São Paulo: Makron Books, 1996.<br>" +
                    "Bibliografia complementar<br>" +
                    "FEOFILOFF, P. Algoritmos em Linguagem C. Editora Campus/Elsevier, 2009. <br>" +
                    "FARRER, H. at al. Programação Estruturada de Computadores: Algoritmos Estruturados. 3.a edição. Rio de Janeiro: LTC, 1989.<br>" +
                    "SEDGEWICK, R. Algorithms in C. 3rd ed. Reading, Mss: Addison-Wesley, 1998.  ISBN 0201314525.<br>" +
                    "SALVETTI, D. D.; BARBOSA, L. M. Algoritmos, São Paulo: Makron Books, 1998.<br>" +
            ...
            },
            {
                ...
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NC",
                    "theme2": "<b>Teórica</b> <br>96",
                    "theme3": "<b>Prática</b> <br>0",
                    "theme4": "<b>Total</b> <br>96",
                    "theme5": "<b>Período</b> <br>1º",
                    "theme6": "<b>Unidade</b> <br>IME",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Nenhum",
                },
                "subtitle": "Ementa",
                "text": "Números reais. Funções reais de uma variável real e suas inversas. <br>" +
                    ...
                    "Aplicações.<br>",
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "GUIDORIZZI, H. L. Um Curso de Cálculo, vol. 1. LTC, Rio de Janeiro, Brasil, 2006.<br>" +
                    "LEITHOLD, L. O Cálculo com Geometria Analítica, 3.a edição. vol. 1. Harbra, São Paulo, 1994.<br>" +
                    "STEWART, J. Cálculo, 5.a edição. vol. 1. Cengage Learning, São Paulo, 2006.<br>" +
                "<br>Bibliografia Complementar<br><br>" +
                "ÁVILA, G. S. S. Cálculo: Funções de Uma Variável, 7.a edição. vol. 1. LTC: Rio de Janeiro, 1994.<br>" +
                "FLEMMING, D. M.; GONÇALVES, M. B. Cálculo A: Funções, limite, derivação e integração. Makron Books do Brasil, São Paulo, 2006.<br>" +
                "HOFFMANN, L. D.; BRADLEY, G. L. Cálculo: Um curso moderno com aplicações, 9.a edição. LTC, Rio de Janeiro, 2008.<br>" +
                "REIS, G. L; SILVA, V. V. Geometria Analítica. LTC, São Paulo.\t\t<br>" +
                "SIMMONS, G. F. Cálculo com Geometria Analítica, vol. 1. McGraw-Hill do Brasil, São Paulo, Brasil, 1987.<br>"
            },
            {
                "title": "Fundamentos de Matemática para Computação",
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NC",
                    "theme2": "<b>Teórica</b> <br>64",
                    "theme3": "<b>Prática</b> <br>0",
                    "theme4": "<b>Total</b> <br>64",
                    "theme5": "<b>Período</b> <br>1º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Nenhum",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "GERSTING, J. L. Fundamentos Matemáticos para a Ciência da Computação, 5.a edição, Editora LTC, Rio de Janeiro, 2004.<br>" +
                    "SCHEINERMAN, E. R. Matemática Discreta: Uma introdução, Cengage Learning, Thompson Pioneira, 2003<br>" +
                    "GRIMALDI, R. P. Discrete and Combinatorial Mathematics: An Applied Introduction, 5th edition, Pearson - Addison-Wesley, Boston, 2003.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "GONÇALVES, A. Introdução à Álgebra, 5.a edição, CNPQ-IMPA, Rio de Janeiro, 2013.<br>" +
                    "MATTSON, Jr.; H. F. Discrete Mathematics with applications, John Wiley & Sons, New York, 1993.<br>" +
                    "ROSEN, K. H. Discrete Mathematics and Its Applications, 6.a edição, Boston: McGraw-Hill, 2009. <br>" +
                    "ROSS, K. A.; Wright, C. R. B. Discrete mathematics, Prentice Hall, 1998.<br>" +
                    "SANTOS, J. P. O. Introdução à Teoria dos Números, Coleção Matemática Universitária, CNPQ-IMPA, Rio de Janeiro, 2003.<br>"
            }
        ], // Fecha o Primeiro
        [  // Segundo Semestre
            {
                ...
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NC",
                    "theme2": "<b>Teórica</b> <br>48",
                    "theme3": "<b>Prática</b> <br>16",
                    "theme4": "<b>Total</b> <br>64",
                    "theme5": "<b>Período</b> <br>2º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Fundamentos de Matemática para Computação",
                },
                "subtitle": "Ementa",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BRYANT, R.; O'RALLARON, D. Computer Systems: A Programmer's Perspective, 2nd Edition, Addison Wesley, 2010.<br>" +
                    "STALLINGS, W. Arquitetura e Organização de Computadores, 5a. Edição, Prentice-Hall, 2002.<br>" +
                    "TANENBAUM, A. Organização Estruturada de Computadores, Editora LTC, 2006.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "HENNESSY, J. L.; PATTERSON, D. A. Computer Architecture: A Quantitative Approach, 4th Edition, Morgan Kaufmann, 2007. <br>" +
                    "MONTEIRO, M. A.  Introdução à Organização de Computadores.  4ª.  Edição. Editora LTC, Rio de Janeiro, 2001. ISBN: 8521612915.<br>" +
                    "PATTERSON, D. A.; HENNESSY, J. L. Computer Organization and Design: The Hardware/Software Interface, 3rd edition, Morgan Kaufmann, 2007.<br>" +
                    "STALLINGS, W. Computer Organization and Architecture: Designing for Performance. 10th Edition. Prentice-Hall, Inc., Upper Saddle River, NJ, USA.  2010.<br>" +
            ...
            },
            {
                ...
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NC",
                    "theme2": "<b>Teórica</b> <br>32",
                    "theme3": "<b>Prática</b> <br>32",
                    "theme4": "<b>Total</b> <br>64",
                    "theme5": "<b>Período</b> <br>2º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Introdução à Programação",
                },
                "subtitle": "Ementa",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "FEOFILOFF, P. Algoritmos em Linguagem C. Editora Campus/Elsevier, 2009.<br>" +
                    "SZWARCFITER, J. L.; MARKENZON, L. Estruturas de Dados e seus Algoritmos. 2ª edição, LTC, 1994.<br>" +
                    "TENENBAUM, A. M.; LANGSAM, Y.; AUGENSTEIN, M. Estruturas de Dados Usando C, São Paulo, Makron Books, 1995. <br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "CORMEN, T. H. et al., Algoritmos: Teoria e Prática. 2.ª edição, Rio de Janeiro: Editora Campus, 2002.<br>" +
                    "SALVETTI, D. D.; BARBOSA, L. M.; Algoritmos, Makron Books, São Paulo, 1998.<br>" +
                    "SEDGEWICK, R. Algorithms in C++ (Parts 1-4), Addison-Wesley, 3rd Edition, 1998.<br>" +
                    "ZIVIANI, N. Projeto de Algoritmos com implementação em Pascal e C. São Paulo: Editora Thomson, 3.ª edição, 2010.<br>" +
                    "ZIVIANI, N. Projeto de Algoritmos com implementação em Java e C++. São Paulo: Editora Thomson, 2006.<br>"
            },
            {
                ...
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>IME",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Cálculo 1A",
                },
                "subtitle": "Ementa",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "MAGALHÃES, M. N. Noções de Probabilidade e Estatística. São Paulo: EDUSP, 7.a ed., 2010.<br>" +
                    "MEYER, P. L. Probabilidade: Aplicações à Estatística. Rio de Janeiro: LTC, 1969.<br>" +
                    "WALPOLE, R. E.; MYERS, R. H.; MYERS, S. L.; YE, K. Probabilidade e Estatística para Engenharia e Ciências. São Paulo: Pearson, 8.a ed., 2009.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "BUSSAB, W. O.; MORETTIN, P. A. Estatística Básica. 6.a ed. São Paulo: Saraiva, 2010.<br>" +
                    "DANTAS, C. A. B. Probabilidade: um Curso Introdutório. 3.a ed. São Paulo: EDUSP, 2008.<br>" +
                    "MORETTIN, L. G. Estatística básica: probabilidade e inferência. São Paulo: Prentice Hall, 2010.<br>" +
                    "ROSS, S. Probabilidade. Um Curso Moderno com Aplicações. 8.a ed. Porto Alegre: Bookman, 2010.<br>" +
            ...
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BOLDRINI, J. L.; COSTA, S. I. R; FIGUEIREDO, V. L; WETZLER, H. G. Álgebra Linear, 3.a ed. Harbra, São Paulo, 2003.<br>" +
                    "CALLIOLI, C. A.; DOMINGUES, H. H; COSTA, R. C. F. Álgebra Linear e Aplicações. Atual, Brasil, 1983.<br>" +
                    "LIPSCHUTZ, S. Álgebra Linear, 2.a ed. Makrom-Books, São Paulo, Brasil, 1974.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "APOSTOL, T. Linear Algebra: A First Course with Applications to Differential Equations, 1st ed. Wiley-Interscience, 1997. <br>" +
                    "HOFFMAN, K.; KUNZE, R. Álgebra Linear. Polígono, São Paulo, 1971.<br>" +
                    "HOWARD, A.; RORRES, C. Álgebra Linear com Aplicações, 8.a ed. Bookman, Porto Alegre, Brasil, 2001.<br>" +
                    "LIMA, E. L. Álgebra Linear: Coleção Matemática Universitária. IMPA, Rio de Janeiro, Brasil, 2006.<br>" +
            ...
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "SOUZA, J. N. Lógica para Ciência da Computação. Editora Campus, 3.a Edição, 2015.<br>" +
                    "SILVA, F. C.; FINGER, M.; MELO, A. C. V. Lógica para Computação. Thomson Learning, 2006.<br>" +
                    "HUTH, M.; RYAN, M. Lógica em Ciência da Computação: modelagem e argumentação sobre sistemas. 2.a edição. Editora LTC, 2008.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "MORTARI, C. Introdução à Lógica. São Paulo: UNESP. 2001.<br>" +
                    "MENDELSON, E. Introduction to Mathematical Logic, Academic Press, 2000.<br>" +
                    "ENDERTON, H. A. Mathematical Introduction to Logic. Academic Press 2000.<br>" +
                    "SMULLYAN, R. Lógica de Primeira Ordem. São Paulo: UNESP. 2009.<br>" +
                    "CASANOVA, M. A.; GIORNO, F. A. C.; FURTADO, A. L. Programação em Lógica e a Linguagem PROLOG. Edgard Blucher, 1987.<br>"
            }
        ], // Fecha o Segundo
        [  // Terceiro Semestre
            {
                ...
                "body": {
                    ...
                    "theme3": "<b>Prática</b> <br>32",
                    "theme4": "<b>Total</b> <br>64",
                    "theme5": "<b>Período</b> <br>3º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Introdução à Programação",
                },
                "subtitle": "Ementa",
                "text": "Abstração e tipos abstratos de dados. <br>" +
                    ...
                    "Noções de UML. <br>" +
                    "Noções de padrões de projeto orientado a objetos.<br>",
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BORATTI, I. C. Programação orientada a objetos em Java. 1.a Edição. Visual Books, 2007.<br>" +
                    "ECKEL, B. Thinking in Java. Prentice Hall, 3.a Edição, 2002.<br>" +
                    "DEITEL, P. J.; DEITEL, H. M. Java: como programar 6.a ed. São Paulo: Prentice Hall, 2005. 1386 p.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "BUDD, T. An Introduction to Object-Oriented Programming. Addison Wesley, 1996.<br>" +
                    "GAMMA, E. et al. Design patterns: elements of reusable object-oriented software. Reading: Addison Wesley, 1995. <br>" +
                    "HORSTMANN, C. S. Core Java – Volume II – Advanced Features, Prentice Hall, 8.a Edição, 2008.<br>" +
                    "SANTOS, R. Introdução à Programação Orientada a Objetos com Java. Campus, 2003.<br>" +
                    "ZEIGLER, B. P. Objects and Systems: Principled Design with Implementations in C++ and Java. Springer-Verlag New York, Inc., New York, NY, USA. 1997<br>"
            },
            {
                ...
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Algoritmos e Estruturas de Dados 1",
                },
                "subtitle": "Ementa",
                ...
                "TENENBAUM, A. M.; LANGSAM, Y.; AUGENSTEIN, M. Estruturas de Dados Usando C, São Paulo, Makron Books, 1995. <br>" +
                "<br>Bibliografia Complementar<br><br>" +
                "CORMEN, T. H. et al., Algoritmos: Teoria e Prática. 2ª edição, Rio de Janeiro: Editora Campus, 2002.<br>" +
                "SALVETTI, D. D. e BARBOSA, L. M., Algoritmos, Makron Books, São Paulo, 1998.<br>" +
                "SEDGEWICK, R. Algorithms in C++ (Parts 1-4), 3rd edition, Addison-Wesley, 1998.<br>" +
                "ZIVIANI, N. Projeto de Algoritmos com implementação em Pascal e C. 3ª edição, São Paulo: Editora Thomson, 2010.<br>" +
                "ZIVIANI, N. Projeto de Algoritmos com implementação em Java e C++. São Paulo: Editora Thomson, 2006.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "GHEZZI, C.; JAZYERI, M. Programming Language Concepts, 3rd Edition, Wiley; 3rd Edition; 1997.<br>" +
                    "SCOTT, M. L. S. Programming Language Pragmatics, 3rd Edition, Morgan Kaufmann, 2009.<br>" +
                    "SEBESTA, R. W. Concepts of Programming Languages; 10th Edition, Pearson, 2012.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "FRIEDMAN, D. P.; WAND, M. Essentials of Programming Languages, 3rd Edition, The MIT Press, 2008.<br>" +
                    "PRATT, T. W.; ZELKOWITZ, M. V. Programming Languages: Design and Implementation, 4th Edition, Prentice Hall, 2000.<br>" +
                    "ROY, P. V.; HARIFI, S. Concepts, Techniques, and Models of Computer Programming, 1st Edition, The MIT Press, 2004.<br>" +
                    "TURBAK, F.; GIFFORD, D. Design Concepts in Programming Languages, 1st Edition, The MIT Press, 2008.<br>" +
                    "VAREJÃO, F. Linguagens de Programação, 1.a Edição, Editora. Campus, 2004.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "PRESSMAN, R.; MAXIM, B. Software Engineering: A Practitioner’s Approach, 8th edition, McGraw-Hill, 2014.<br>" +
                    "SOMMERVILLE, I. Software Engineering, 10th Edition, Pearson, 2016.<br>" +
                    "WAZLAWICK, R. S. Engenharia de software: teoria e prática. Campus, 2013.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "ISO/IEC/IEEE 24765. Systems and software engineering - Vocabulary, 2010. Portal de periódicos da CAPES (http://goo.gl/FrGm7c).<br>" +
                    "MAGELA, R. Engenharia de software aplicada. Alta Books, 2006.<br>" +
                    "MPS.BR.  Melhoria de Processos do Software Brasileiro. Disponível em http://www.softex.br/mpsbr/, último acesso julho/2016.<br>" +
                    "Software Engineering Body of Knowledge (SWEBOK), V3, IEEE, Disponível em https://www.computer.org/web/swebok. <br>" +
                    "Software Engineering Competency Model (SWECOM), IEEE. Disponível em https://www.computer.org/web/peb/swecom. "
            },
            {
                "title": "Sistemas Operacionais",
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NE",
                    "theme2": "<b>Teórica</b> <br>32",
                    "theme3": "<b>Prática</b> <br>32",
                    "theme4": "<b>Total</b> <br>64",
                    "theme5": "<b>Período</b> <br>3º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Não",
                    "theme8": "<b>Pré-requisito</b> <br>Arquitetura de Computadores",
                },
                "subtitle": "Ementa",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "OLIVEIRA, R. S.; CARISSIMI, A. S.; TOSCANI, S. S. Sistemas Operacionais. 3.a edição. Porto Alegre: Instituto de Informática da UFRGS: Editora Sagra Luzzatto, 2004.<br>" +
                    "SILBERSCHATZ, A. Fundamentos de Sistemas Operacionais, 8.a edição, LTC, 2011.<br>" +
                    "TANEMBAUM, A. S. Sistemas Operacionais Modernos. 3.a edição. São Paulo: Editora Prentice Hall, 2010. ISBN 9788576052371.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "DEITEL, H. Sistemas Operacionais, Prentice Hall, 2005.<br>" +
                    "MACHADO, F. B. Arquitetura de Sistemas Operacionais. 2.a edição. LTC, 1997.<br>" +
                    "NEMETH E.; SNYDER, G.; HEIN, T. R. Unix system administration handbook. Pearson Prentice Hall, 1997. ISBN 9788576051121.<br>" +
                    "O'GORMAN, J. Operating Systems with Linux. Palgrave, 2001.<br>" +
                    "SHAY, W. Sistemas Operacionais, Makron Books, 1996.<br>"
            },
            {
                ...
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Não",
                    "theme8": "<b>Pré-requisito</b> <br>Álgebra Linear",
                },
                "subtitle": "Ementa",
                "text": "Modelagem. <br>" +
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BREGALDA, P. F.; OLIVEIRA, A. A. F.; BORNSTEIN, C. T. Introdução à programação linear. 3. ed. Rio de Janeiro: Campus, 1983.<br>" +
                    "GOLBARG, M.; LUNA, H. Otimização combinatória e programação linear. 2. ed. Campus, 2005.<br>" +
                    "TAHA, H. Pesquisa operacional. 8. ed. Prentice Hall, 2008. <br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "BAZARAA M. S.; JARVIS, J. J.; SHERALI, H. D. Linear programming and network Flows.  Wiley, 2009.<br>" +
                    "HILLIER, F. S.; LIEBERMAN, G. J. Introdução à pesquisa operacional. 9.a edição. Amgh Editora, 2013.<br>" +
                    "PARLAR, M. Interactive operations research with Maple: methods and models. Birkhauser, 2000.<br>" +
                    "SILVA, E. M. et al. Pesquisa Operacional: programação linear, simulação. 3.a ed. Atlas, 1998.<br>" +
                    "WINSTON, W. L. Operations research applications and algorithms. 3rd ed. Duxbury Press, 1997.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "SUDKAMP, T. A. Languages and machines. 3.a edição. Addison Wesley, 2006.<br>" +
                    "SIPSER, M. Introduction to the theory of computation. ITP, 1997. ISBN 053494728X.<br>" +
                    "HOPCROFT, J. E.; MOTWANI, R.; ULLMAN, J. D. Introdução à teoria de autômatos: linguagens e computação. Campus, 2002.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "RAMOS, M. V. M.; NETO, J. J.; VEGA, I. S. Linguagens formais: teoria, modelagem e implementação. Bookman, 2009.<br>" +
                    "CARROLL, J.; LONG, D. Theory of finite automata. New Jersey: Prentice-Hall International Editions, 1989.<br>" +
                    "LEWIS, H. R.; PAPADIMITRIOU, C. H. Elementos de teoria da computação. 2.a edição. Porto Alegre: Bookman, 2000.<br>" +
                    "MENEZES, P. F. B. Linguagens formais e autônomos. 5.a edição. Porto Alegre: Sagra Luzzatto, 2005. <br>" +
                    "ROSEN, K. H. Matemática discreta e suas aplicações. 6.a ed. Rio de Janeiro: McGraw Hill, 2009.<br>"
            }
        ], // Fecha o Terceiro
        [  // Quarto Semestre
            {
                ...
                "body": {
                    ...
                    "theme3": "<b>Prática</b> <br>0",
                    "theme4": "<b>Total</b> <br>64",
                    "theme5": "<b>Período</b> <br>4º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Fundamentos de Matemática para Computação<br>" +
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BRASSARD, G.; BRATLEY, P. Fundamentals of Algorithmics. Prentice-Hall, Inc., Upper Saddle River, NJ, 1996. ISBN: 0-13-335068-1. <br>" +
                    "CORMEN, T. H.; LEISERSON, C. E.; RIVEST, R. L.; STEIN,  C. Algoritmos: Teoria e Prática, 3.a edição, Campus, 2012.<br>" +
                    "PAPADIMITRIOU, C. H.; VAZIRANI, U. V.; DASGUPTA, S. Algoritmos. 2009. McGraw-Hill Brasil. ISBN 9788577260324.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "AHO, A. V.; HOPCROFT, J. E.; ULLMAN, J. D. The Design and Analysis of Computer Algorithms, Addison-Wesley Publishing Company, 1974. ISBN 0-201-00029-6.<br>" +
                    "BAASE, S.; GELDER, A. V. Computer Algorithms: Introduction to Design and Analysis, 3rd Edition, Pearson, 1999.<br>" +
                    "MAMBER, U. Introduction to Algorithms. Addison Wesley Publishing Company. 1989.<br>" +
                    "SEDGEWICK, R.; WAYNE, K. Algorithms. 4th edition, Addison-Wesley Professional, 2011. ISBN: 978-0321573513<br>" +
            ...
            },
            {
                ...
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Probabilidade e Estatística <br>" +
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "DIX, A.; FINLAY, J. E.; ABOWD, G. D.; BEALE, R. Human­Computer Interaction (3rd Edition). Prentice­Hall, Inc., Upper Saddle River, NJ, USA, 2003.<br>" +
                    "ROGERS, Y.; SHARP, H.; PREECE, J. Design de Interação ­ Além da Interação Homem­computador. 3a Ed., Porto Alegre: Bookman, 2013.<br>" +
                    "TIDWELL, J. Designing Interfaces: Patterns for Effective Interaction Design. O’Reilly. Segunda edição, 2011.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "BARBOSA, S. D. J.; SILVA, B. S. Interação Humano­Computador. Elsevier Editora. 1.a edição. 2010.<br>" +
                    "JACKO, Julie A. The human­computer interaction handbook: fundamentals, evolving technologies, and emerging applications. CRC Press, 2012.<br>" +
                    "LAZAR, J.; FENG, J. H.; HOCHHEISER, H. Research Methods in Human­Computer Interaction. Wiley, 2009.<br>" +
                    "MACKENZIE, I. S. Human­computer Interaction: An Empirical Research Perspective. Morgan Kaufmann, 201 3. ISBN: 978­0­1 2­405865­1<br>" +
                    "SCOTT, B.; NEIL, T. Designing Web Interfaces: Principles and Patterns for Rich Interactions. O'Reilly Media; 1st edition. 2009.<br>"
            },
            {
                ...
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Lógica Matemática"
                },
                "subtitle": "Ementa",
                "text": "Conceitos básicos de Banco de Dados. <br>" +
                    ...
                    "Normalização.<br>",
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "ELMASRI, R.; NAVATHE, S. B. Sistemas de Banco de Dados, 6.ª ed., Pearson - Addison Wesley, 2011.<br>" +
                    "HEUSER, C. A. Projeto de Banco de Dados, 6.ª edição, Bookman, Porto Alegre, 2009.<br>" +
                    "SILBERSCHATZ, A.; KORTH, H. F.; SUDARSHAN, S. Sistema de Banco de Dados, 5.ª edição, Editora Campus, Rio de Janeiro, 2006.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "CONNOLLY, T. M.; BEGG, C. E.; STRACHAN, A. D. Database systems: a practical approach to design, implementation and management, 3rd. Edition, Addison Wesley, 2010.<br>" +
                    "DATE, C. J. Introdução a Sistemas de Banco de Dados, tradução da 8.a edição americana, Editora Campus, Rio de Janeiro, 2004.<br>" +
                    "GARCIA-MOLINA, H.; ULLMAN, J. D.; WIDOM, J. D. Database Systems: The Complete Book, 2.a edição, Prentice Hall, 2009<br>" +
                    "RAMAKRISHNAN, R.; GEHRKE, J. Sistemas de Gerenciamento de Banco de Dados, tradução da 3.a edição, São Paulo, McGraw-Hill, 2008.<br>" +
                    "TEOREY, T.; LIGHTSTONE, S.; NADEAU, T. Projeto e Modelagem de Bancos de Dados, Editora Campus, Rio de Janeiro, 2007.<br>"
            },
            {
                ...
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Engenharia de Software<br>" +
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BUDGEN, B. Software Design, 2nd edition, Addison­Wesley, 2003.<br>" +
                    "BASS, L. et al. Software Architecture in Practice, 3rd edition, Addison­Wesley, 2012.<br>" +
                    "LARMAN, C. Utilizando UML e padrões: uma introdução à análise e ao projeto orientados a objetos e ao desenvolvimento interativo. Bookman, 2008.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "BOOCH, G. UML guia do usuário: o mais avançado tutorial sobre Unified Modeling Language (UML). Elsevier, 2006.<br>" +
                    "FREEMAN, E. et al. Use a cabeça!: padrões de projetos, (design patterns), Alta Books, 2007.<br>" +
                    "FOWLER, M. Patterns of enterprise application architecture. Addison­Wesley, 2003.<br>" +
                    "GAMMA, E. et al. Design patterns elements of reusable object-oriented software. Reading: Addison Wesley, 1995. <br>" +
                    "NYGARD, M. Release It!: Design and Deploy Production­Ready Software, Pragmatic Bookshelf, 2007.<br>"
            },
            {
                ...
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Não",
                    "theme8": "<b>Pré-requisito</b> <br>Sistemas Operacionais",
                },
                "subtitle": "Ementa",
                "text": "Fundamentos. <br>" +
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "KUROSE, J.F.; ROSS, K. Redes de Computadores e a Internet, 6.a edição. Pearson Education, 2013.<br>" +
                    "LAUDON, K. C.; LAUDON, J. P. Sistemas de Informação Gerenciais. 9.a edição. São Paulo: Pearson Education, 2013.<br>" +
                    "TANENBAUM, A. S. Computer Networks, 4th edition, Prentice Hall, 2003.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "DANTAS, M. Redes de comunicação e computadores: abordagem quantitativa. Visual Books, 2009. ISBN 9788575022559.<br>" +
                    "PETERSON, L. L.; DAVIE, B. S. Redes de Computadores: Uma Abordagem de Sistemas, 3.a edição. Campus Elsevier, 2004.<br>" +
                    "SOARES, L. F. G; SOUZA FILHO, G. L.; COLCHER, S. Redes de computadores: das LANS, MANS e WANS às Redes ATM. Editora Campus, 1995. ISBN 857001998X.<br>" +
                    "STALLINGS, W. Data and Computer Communications, 8th edition, Pearson/Prentice Hall, 2007.<br>" +
                    "TORRES, G. Redes de computadores: curso completo. Axcel Books, 2001.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "FELIPE, T.; MONTEIRO, M. S. LIBRAS em contexto. Curso Básico. Brasília: Ministério da Educação e do Desporto/Secretaria de Educação Especial, 2001.<br>" +
                    "PEREIRA, M. C. C.; et al. LIBRAS – Conhecimento além dos sinais. São Paulo: Pearson, 2011.<br>" +
                    "PIMENTA, N.; QUADROS, R. M. Curso de LIBRAS 1 – Iniciante. 3.a edição. Porto Alegre: Pallotti, 2008.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "ALMEIDA, E. C.; DUARTE, P. M. Atividades ilustradas em sinais da Libras. São Paulo: Revinter, 2004.<br>" +
                    "BRITO, L. F. Por uma gramática de língua de sinais. Rio de Janeiro: Tempo Brasileiro, 1995.<br>" +
                    "CAPOVILLA, F. C.; RAPHAEL, W. D.; MAURÍCIO, A. C. L. Dicionário Enciclopédico Ilustrado Trilíngue da Língua de Sinais Brasileira, v 1 e 2. São Paulo: Editora da Universidade de São Paulo, 2010.<br>" +
                    "CAPOVILLA, F. C.; RAPHAEL, W. D. (ed.). Enciclopédia da Língua de Sinais Brasileira. v. 1 e 2. São Paulo: EDUSP, 2004.<br>" +
                    "GESSER, A. LIBRAS? Que língua é essa?: Crenças e preconceitos em torno da língua de sinais e da realidade surda. São Paulo: Parábola Editorial, 2009.<br>" +
                    "QUADROS, R. M.; KARNOPP, L. Língua de sinais brasileira: estudos linguísticos. ARTMED: Porto Alegre, 2004.<br>"
            },
            {
                "title": "Compiladores",
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Não",
                    "theme8": "<b>Pré-requisito</b> <br>Linguagens Formais e Autômatos<br>" +
                                "Algoritmos e Estruturas de Dados 2",
                },
                "subtitle": "Ementa",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "AHO, A. V; LAM, M. S.; SETHI, R.; ULLMAN, J. D. Compiladores: Princípios, técnicas e ferramentas. 2.a ed. Pearson-Addison-Wesley, 2008.<br>" +
                    "LOUDEN, K. C. Compiladores - Princípios e Práticas. Editora Thompson 2004.<br>" +
                    "APPEL, A. W. Modern Compiler Implementation in C - Basic Techiniques. Cambridge University Press, 1997.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "APPEL, A. W. Modern Compiler Implementation in Java. 2nd edition. New York: Cambridge University Press, 2002.<br>" +
                    "HOLMES, J. Modern Compiler Implementation in Java. Prentice Hall, 1995.<br>" +
                    "MUCHNICK, S. S. Advanced Compiler Design and Implementation. Morgan Kaufmann, 1997.<br>" +
                    "HANSON, D. R.; FRASER, C. W. A Retargetable C Compiler: Design and Implementation. Benjamin Cummings Pub., 1995.<br>" +
                    "LEBLANC, R. J.; FISCHER, C. N. Crafting a Compiler with C.  Benjamin/Cummings, 1991.<br>"
            }
        ], // Fecha o Quarto
        [  // Quinto Semestre
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "MCCONNELL, S. Code Complete: um guia prático para a construção de software 2.a edição. Porto Alegre, RS: Bookman, 2005. ISBN 8536305045.<br>" +
                    "GOODLIFFE, P. Como ser um programador melhor. Novatec, 2015. ISBN 978-85-7522-415-1.<br>" +
                    "ORAM, A.; WILSON, G. Beautiful code. O'Reilly, 2007. ISBN 9780596510046.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "FOWLER, M. Refatoração: aperfeiçoando o projeto de código existente Porto Alegre: Bookman, 2004, ISBN 8536303956.<br>" +
                    "IRVINE, K. R. C++ and object-oriented programming Upper Saddle River: Prentice-Hall, 1997. 526 p. Bibliografia e indice ISBN 0023598522 (broch.)<br>" +
                    "BECK, K. Implementation patterns Upper Saddle River, NJ: Addison-Wesley, 2008. ISBN 0321413091.<br>" +
                    "MARTIN, R. C. Clean code: a handbook of agile software craftsmanship. Prentice Hall, 2009. ISBN 0132350882.<br>" +
                    "AGANS, D. J. Debugging the nine indispensable rules for finding even the most elusive software and hardware problems. AMACOM, 2002. ISBN 0814471684.<br>"
            },
            {
                "title": "Modelagem de Software",
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NC",
                    "theme2": "<b>Teórica</b> <br>16",
                    "theme3": "<b>Prática</b> <br>48",
                    "theme4": "<b>Total</b> <br>64",
                    "theme5": "<b>Período</b> <br>5º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "EVANS, E. Domain-driven design: tackling complexity in the heart of software Boston, MA: Addison-Wesley, 2004, ISBN 0321125215.<br>" +
                    "MCLAUGHLIN, B. D.; POLLICE, G.; WEST, D. Head First Object-Oriented Analysis & Design, O’Reilly, 2006.<br>" +
                    "AMBLER, S. W. Agile modeling: effective practices for eXtreme programming and the unified process. Wiley, 2002. ISBN 0471202827.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "MILLETT, S.; TUNE, N. Patterns, Principles and Practices of Domain-Driven Design. Wrox, 2015.<br>" +
                    "FOWLER, M. Analysis patternsreusable object models. Addison-Wesley, 1997. ISBN 0201895420.<br>" +
                    "MELLOR, S. J; SHLAER, S. Análise de sistemas orientada para objetos. São Paulo: McGraw-Hill, 1990.<br>" +
                    "KOWAL, J. A Behavior models: specifying user's expectations. Prentice Hall, 1992. ISBN 0132927152.<br>" +
                    "WAGNER, F. Modeling software with finite state machinesa practical approach. Auerbach, 2006. ISBN 9780849380860<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "FAIRLEY, R. E. Managing and Leading Software Projects, Wiley-IEEE Computer Society Press, 2009.<br>" +
                    "ISO/IEC/IEEE 12207:2008. Standard for Systems and Software Engineering-Software Life Cycle Processes. Portal: http://goo.gl/5ixAtq.<br>" +
                    "LARMAN, C. Agile and iterative development: a manager's guide. Addison-Wesley, 2004. ISBN 9780131111554.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "JOHNSON, K. A.; KULPA, M. K. Interpreting the CMMIa process improvement approach. Auerbach, 2003. ISBN 0849316545.<br>" +
                    "BEEDLE, M.; SCHWABER, K. Agile software development with Scrum. Prentice Hall, 2002. ISBN 0130676349.<br>" +
                    "PROWELL, S. J. Cleanroom software engineering technology and process Reading, Mass.: Addison-Wesley, 1999. ISBN 0201854805.<br>" +
                    "CAPUTO, K. CMM implementation guide choreographing software process improvement. Addison-Wesley, 1998. ISBN 0201379384.<br>" +
                    "MAGUIRE, S. Debugging the development processpractical strategies for staying focused, hitting ship dates, and building solid teams. Microsoft, 1994. ISBN 1556156502.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "SCHNEIDEWIND, N. Systems and Software Engineering with Applications. New York, NY: IEEE, 2009.<br>" +
                    "INCOSE. Systems Engineering Handbook: A Guide for System Life Cycle Processes and Activities, version 3.2.2. International Council on Systems Engineering (INCOSE), INCOSE-TP-2003-002-03.2.2, 2012. <br>" +
                    "WIDRIG, D.; LEFFINGWELL, D. Managing software requirements: a unified approach Boston: Addison-Wesley, 2001. ISBN 0201615932.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "MADACHY, R. J. Systems Engineering Principles for Software Engineers (Chapman & Hall/CRC Innovations in Software Engineering and Software Development Series) 1st Edition, CRC Press, 2016.<br>" +
                    "WILSON, W. E. Conceptos sobre ingenieria de sistemas Buenos Aires: Centro regional de Ayuda Tecnica, 1968. 254 p., il.<br>" +
                    "SILVA FILHO, B. S.; NISE, N. S. Engenharia de sistemas de controle. 3.a edição. LTC, 2002, ISBN 85-216-1301-6.<br>" +
                    "MAFFEO, B. Engenharia de software e especificação de sistemas. Rio de Janeiro: Campus, 1992. 484 p. ISBN 8570017014.<br>" +
                    "NASCIMENTO, J. B. Metodologias de desenvolvimento de sistemas. São Paulo: Erica, 1993, ISBN 8571941483.<br>"
            }
        ], // Fecha o Quinto
        [
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BUDGEN, D. Software Design, International Edition, 2nd Edition, Pearson Education, 2011.<br>" +
                    "HALL, G. M. Adptive Code via C#: Agile coding with design patterns and SOLID principles. Microsoft Press, 2014.<br>" +
                    "RUPING, A. Agile documentationa pattern guide to producing lightweight documents for software projects. Wiley, 2003. ISBN 0470856173.<br>" +
                    "<br>Bibliografia complementar <br><br>" +
                    "MILLETT, S.; TUNE, N. Patterns, Principles, and Practices of Domain-Driven Design, John Wiley & Sons, 2015.<br>" +
                    "ARGILA, C.; YOURDON, E. Análise e projeto orientados a objetos: estudos de casos São Paulo: Makron Books, 1999. ISBN 8534609756.<br>" +
                    "LARMAN, C. Applyng UML and patternsan introduction to object-oriented analysis and design. Prentice Hall PTR, 1997. ISBN 0137488807.<br>" +
                    "EVANS, E. Domain-driven designtackling complexity in the heart of software Boston, MA: Addison-Wesley, 2004. ISBN 0321125215.<br>" +
                    "HORSTMANN, C. S. Object-oriented design & patterns. 2nd edition. Hoboken, NJ: Wiley, 2006. ISBN 0471744875.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "PILONE, D.; MILES, R.; Head-First Software Development, O’Reilly, 2008.<br>" +
                    "MCLAUGHLIN, B. D.; POLLICE, G.; WEST, D. Head First Object-Oriented Analysis & Design, O’Reilly, 2006.<br>" +
                    "BOOCH, G. Object-oriented analysis and design with applications. 2nd edition. Addison-Wesley, 1994. ISBN 0805353402.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "WAZLAWICK, R. S. Análise e design orientados a objetos para sistemas de informação: Modelagem com UML, OCL e IFML. 3.a edição. Campus, 2010.<br>" +
                    "PENKER, M.; ERIKSSON, H. E. Business modeling with UML: business patterns at work. John Wiley & Sons, 2000. ISBN 0471295515. <br>" +
                    "ODELL, J. J. Advanced object-oriented analysis and design using UML. Cambridge University Press, SIGS Books, 1998. ISBN 052164819X<br>" +
                    "COCKBURN, A. Agile software development Boston: Addison-Wesley, 2002. (Agile software development series). ISBN 0201699699.<br>" +
                    "BEEDLE, M.; SCHWABER, K. Agile software development with Scrum. Prentice Hall, 2002. (Series in agile software development). ISBN 0130676349.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "Stefan Wagner. Software Product Quality Control. Springer-Verlag Berlin Heidelberg. 2013.<br>" +
                    "Software Quality Assurance: From Theory to Implementation, Daniel Galin, Addison-Wesley, 2004<br>" +
                    "MURPHY, Mark L C/C++ software quality tools Upper Saddle River: Prentice Hall PTR, 1996. ISBN 0134451236.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "OSCIANSK, A.; SOARES, M. S. Qualidade de Software. Editora Novatec, 2007.<br>" +
                    "CERTIFICAÇÃO CERTICS: um instrumento de política pública para inovação tecnológica em software. CTI Renato Archer, 2015. ISBN 9788565163088.<br>" +
                    "KELLIHER, T. P.; KEEGAN, J. G.; OLIVER, D. W. Engineering complex systems with models and objects. McGraw-Hill, 1997. ISBN 0070481881.<br>" +
                    "KAN, S. H. Metrics and models in software quality engineering. 2nd edition. Addison-Wesley, 2003. ISBN 0201729156.<br>" +
                    "BARTIÉ, A. Garantia da qualidade de software. Campus, 2002. ISBN 8535211245.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "PMI. Um Guia do Conhecimento em Gerenciamento de Projetos. 5.a edição. São Paulo: Saraiva, 2012. ISBN 9788502223721.<br>" +
                    "CHEMUTURI, M. K.; CAGLEY, T. M. Jr. Mastering Software Project Management: Best Practices, Tools and Techniques. J. Ross Publishing, 2010. ISBN-13: 978-1604270341.<br>" +
                    "COHN, M. Agile estimating and planning Upper Saddle River, NJ: Prentice Hall Professional Technical Reference, 2006. ISBN 0131479415.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "FAIRLEY, R.E. Managing and Leading Software Projects. John Wiley & Sons, 2009.<br>" +
                    "HIGHSMITH, J. A. Agile project management: creating innovative products 2nd. edition. Addison-Wesley, 2010. ISBN 0321658396.<br>" +
                    "SCHWABER, K. Agile project management with Scrum. Microsoft Press, 2004. ISBN 073561993X.<br>" +
                    "DEMARCO, T. Controle de projetos de software: gerenciamento, avaliação, estimativa. Campus, 1991. ISBN 8570015283.<br>" +
                    "MARTINS, J. C. C. Gerenciando projetos de desenvolvimento de software com PMI, RUP e UML. 4.a edição. Brasport, 2007.<br>"
            },
        ], // Fecha o Sexto
        [
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BUTCHER, P. Seven Concurrent Models in Seven Weeks. Pragmatic Bookshelf, 2014. ISBN-10: 1937785653<br>" +
                    "DAIGNEAU, R. Service Design Pattern. Addison-Wesley, 2011. ISBN 032154420X.<br>" +
                    "FOSTER, I. Designing and building parallel programsconcepts and tools for parallel software engineering Reading, Mass.: Addison-Wesley, 1995. ISBN 0201575949.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "NEWMAN, S. Building Microservices. O’Reilly, 2015. <br>" +
                    "BARNES, L. L. Client/server & beyound strategies for 21st century. Prentice-Hall, 1997. ISBN 0135325161.<br>" +
                    "SHATZ, S. M. Development of distributed software concepts and tools. Macmillan, 1993. ISBN 0024096113.<br>" +
                    "PAGE-JONES, M. Fundamentals of object-oriented design in UML.  Addison-Wesley, 2003. ISBN 020169946X.<br>" +
                    "RODRIGUES, L.; GUERRAOUI, R. Introduction to reliable distributed programming. Springer, 2006. ISBN 9783540288459.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "GOTHELF, J.; SEIDEN, J. Lean UX: Applying Lean Principles to Improve User Experience, O’Reilly, 2013.<br>" +
                    "KRUG, S., Don´t make me think: revisited. New Riders, 2014. ISBN 978-0321965516.<br>" +
                    "BORBA, F. E. Ajax: guia de programação. São Paulo: Erica, 2006. ISBN 8536501375.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "PREECE, J.; SHARP, H.; ROGERS, Y. Interaction Design: Beyond Human-Computer Interaction, Wiley, 2015. ISBN 978-1119020752.<br>" +
                    "CYBIS, W. O. Ergonomia e usabilidade: conhecimentos, métodos e aplicações. 2a. edição. São Paulo: Novatec, 2010. ISBN 9788575222324.<br>" +
                    "COUTAZ, J.; BASS, L. Developing software for the user interface. Addison-Wesley, 1991. ISBN 0201510464.<br>" +
                    "HARTSON, H. R.; HIX, D. Developing user interfaces: ensuring usability through product & process. Wiley, 1993. ISBN 0471578134.<br>" +
                    "OLSEN, D. R. Developing user interfaces. Morgan Kaufmann, 1998. ISBN 1558604189.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "BASS, L.; CLEMENTS, P.; KAZMAN, R. Software Architecture in Practice, 3rd edition, Pearson Education, Inc., 2013.<br>" +
                    "CLEMENTS, P.; et al. Documenting Software Architectures: Views and Beyond. 2nd edition, Pearson Eduction, 2011. <br>" +
                    "MENDES, A. Arquitetura de software: desenvolvimento orientado para arquitetura. Rio de Janeiro: Campus, 2002. ISBN 853521013X.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "CERVANTES, H.; KAZMAN, R. Designing Software Archtectures: A Practical Approach, ISBN-13: 978-0134390789, Addison-Wesley, 2016.<br>" +
                    "PUTMAN, J. Architecting with RM-ODP. Prentice Hall, 2001. ISBN 0130191167.<br>" +
                    "HEINEMAN, G. T.; COUNCILL, W. T. Component-based software engineering: putting the pieces together. Addison-Wesley, 2001. ISBN 0201704854.<br>" +
                    "BOSCH, J. Design and use of software architectures: adopting and evolving a product-line approach. Addison-Wesley, 2000. ISBN 0201674947.<br>" +
                    "JOHNSON, R. Expert one-on-one J2EE development without EJB. Wiley Publishing, 2004. ISBN 0764558315.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "WIEGERS, K. E. Software Requirements. Microsoft Press, 3rd edition, 2013.<br>" +
                    "ROBERTSON, S. Mastering the Requirements Process: Getting Requirements Right. Addison-Wesley Professional, 3rd edition, 2012.<br>" +
                    "WINTERS, J. P.; SCHNEIDER, G. Applying use cases: a practical guide, 2nd edition. Addison-Wesley, 2001. (The Addison-Wesley object technology series). ISBN 0201708531.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "COCKBURN, A. Writing Effective Use Cases. Addison-Wesley, 2000.<br>" +
                    "MELLOR, S. J; SHLAER, S. Análise de sistemas orientada para objetos. São Paulo: McGraw-Hill, 1990.<br>" +
                    "MILLER, G.; ARMOUR, F. Advanced use case modeling: software systems. Boston: Addison-Wesley, 2001. (Addison-Wesley object technology series) ISBN 0201615924.<br>" +
                    "YOURDON, E.; COAD, P. Análise baseada em objetos. 2a. edição. Rio de Janeiro: Campus, 1996. ISBN 8535200428.<br>" +
                    "WIEGERS, K. E. More about software requirements: thorny issues and practical advice. Microsoft Press, 2006. ISBN 9780735622678.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "GREMBERGEN, W. V.; HAES, S. Enterprise Governance of Information Technology: Achieving Strategic Alignment and Value. Springer, 2010. ISBN-13 978-1441946621.<br>" +
                    "BROOKS, P. Metrics for Service Management: Designing for ITIL. 1st edition. Van Haren Publishing, 2012.<br>" +
                    "SHIAVON, M. Acordos de nível operacional para controle do processo de manutenção de software, Mestrado em Engenharia Elétrica, Universidade Federal de Goiás, 2009. <br>" +
                    "<br>Bibliografia complementar <br><br>" +
                    "GUTH, S. Contract Negotiation Handbook: Software as a Service. Guth Ventures LLC, 2013.<br>" +
                    "ERDOGMUS, H.; TANIR, O. Advances in software engineering comprehension, evaluation, and evolution. Springer, 2002. ISBN 0387951091.<br>" +
                    "HASS, A. M. J. Configuration management principles and practice. Addison-Wesley, 2003. (The Agile software development series). ISBN 0321117662.<br>" +
                    "MARSHALL, C. Enterprise modeling with UML: designing successful software through business analysis. Addison-Wesley, 2000. ISBN 0201433133.<br>" +
                    "CENTRO DE GESTÃO E ESTUDOS ESTRATÉGICOS. Ciência, tecnologia e sociedade: novos modelos de governança. Brasilia, CGEE, 2005.<br>"
            }
        ], // Fecha o Sétimo
        [  // Oitavo Semestre
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "MCGRAW, G. Software Security: Build Security In. Addison-Wesley, 2006.<br>" +
                    "GREENGARD, S. The Internet of Things. The MIT Press, 2015.<br>" +
                    "WILMSHURST, T. An introduction to the design of small-scale embedded systems. Palgrave, 2001. ISBN 0333929942.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "MANICO, J.; DETLEFESEN, A. Iron-Clad Java: Building Secure Web Applications. McGraw-Hill, 2014.<br>" +
                    "HOWARD, M. 19 deadly sins of software securityprogramming flaws and how to fix them. McGraw-Hill/Osborne, 2005. ISBN 0072260858.<br>" +
                    "MARK, D. Dominando o desenvolvimento no iPhone: explorando o SDK do iPhone. Alta Books, 2009. ISBN 97885760833757.<br>" +
                    "VAHID, F. Embedded system design: a unified hardware/software introduction. John Wiley & Sons, 2002. ISBN 0471386782.<br>" +
                    "KERN, C.; KESAVAN, A.; DASWANI, N. Foundations of security: what every programmer needs to know. Apress, 2007. ISBN 9781590597842.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "REDMOND, E.; WILSON, J. Seven databases in Seven Weeks. Pragmatic Bookshelf, 2012. <br>" +
                    "MCMURTRY, D. et al. Data Access for Highly-Scalable Solutions: Using SQL, NoSQL, and Polyglot Persistence. Microsoft Press, 2013.<br>" +
                    "AMBLER, S. W. Agile database techniques: effective strategies for the agile software developer. Wiley, 2003. ISBN 0471202835.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "AMBLER, S. J.; SADALAGE, P. J. Refactoring Databases. Addison-Wesley, 2006.<br>" +
                    "GOLENDZINER, L. G.; PRICE, R. T. Bancos de dados para aplicações não convencionais. EBAI, 1989. ISBN 950139879.<br>" +
                    "FALINO, J.; HERION, D.; MARTINER, W. Building distributed applications with ADO. John Wiley & Sons, 1999. ISBN 0471317012.<br>" +
                    "KING, G.; BAUER, C. Java Persistence com Hibernate. Ciencia Moderna, 2007. ISBN 9788573936148.<br>" +
                    "MANNINO, M. V. Projeto, desenvolvimento de aplicações e administração de banco de dados. McGraw-Hill, 2008. ISBN 9788577260201.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "FOWLER, M., Patterns of Enterprise Application Architecture, ISBN-13: 978-0321127426, Addison-Wesley, 2002.<br>" +
                    "DAIGNEAU, R., Service Design Patterns, ISBN-13: 978-0321544209, Addison-Wesley, 2011.<br>" +
                    "BUSCHMAN, F. Pattern-oriented software architecture. Wiley, 2001. ISBN 0471606952.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "VERNON, V. Implementing Domain-Driven Design. Addison-Wesley, 2013. ISBN 978-0-321-83457-7.<br>" +
                    "GAMMA, E. Design patterns elements of reusable object-oriented software. Addison Wesley, 1995. ISBN 0201633612.<br>" +
                    "TROTT, J.; SHALLOWAY, A. Design patterns explained: a new perspective on object-oriented design. 2nd ed. Addison-Wesley, 2005. ISBN 0321247140.<br>" +
                    "PREE, W. Design patterns for object-oriented software development. Addison-Wesley, 1995. ISBN 0201422948.<br>" +
                    "FREEMAN, E. et al. Head First design patterns. O'Reilly, 2004. ISBN 0596007124.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "MYERS, G. J. The Art of Software Testing. Wiley. 2011.<br>" +
                    "COPELAND, L. A Practitioner’s Guide to Software Test Design. Artech House, 2003.<br>" +
                    "SYKES, D. A.; MCGREGOR, J. D. A practical guide to testing object-oriented software. Addison-Wesley, 2001. ISBN 0201325640.<br>" +
                    "<br>Bibliografia Complementar<br><br>" +
                    "MESZAROS, G. xUnit test patternsrefactoring test code. Addison-Wesley, 2007. ISBN 0131495054.<br>" +
                    "MOSLEY, D. J. Client-server software testing on the desktop and the Web. Prentice Hall, 2000. ISBN 0131838806.<br>" +
                    "GROSS, H. Component-based software testing with UML. Springer, 2005. ISBN 354020864X.<br>" +
                    "PERRY, W. E. Effective methods for software testing. 2nd edition. J. Wiley, 1999. ISBN 047135418X.<br>" +
                    "WU, M.; LI, K. Effective software test automationdeveloping an automated software testing tool. SYBEX, 2004. ISBN 0782143202.<br>"
            },
            {
                ...
                "body": {
                    ...
                    "theme3": "<b>Teórica</b> <br>48",
                    "theme4": "<b>Prática</b> <br>80",
                    "theme5": "<b>Período</b> <br>8º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Não",
                    "theme8": "<b>Pré-requisito</b> <br>Nenhum",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "JURISTO, N. Basics of software engineering experimentation. Kluwer Academic Publishers, 2001. ISBN 079237990X.<br>" +
                    "WOHLIN, C. et al. Experimentation in Software Engineering. 2nd edition. Springer, 2012.<br>" +
                    "GETTINBY, G; GARDINER, W. P. Experimental design techniques in statistical practice: a practical software-based approach. Horwood Pub., 1998. ISBN 1898563357.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "WAZLAWICK, R. S. Metodologia de Pesquisa para Ciência da Computação. Editora Campus, 2009.<br>" +
                    "WOHLIN, C. Experimentation in software engineering: an introduction. Kluwer Academic, 2000. ISBN 0792386825.<br>" +
                    "POLYAK, B. T. Introduction to optimization. Optimization Software, 1987. ISBN 0911575146.<br>" +
                    "HALL, E. M. Managing risk methods for software systems development. Addison-Wesley, 1998. ISBN 0201255928.<br>" +
                    "QUALIDADE no setor de software brasileiro. Brasilia, D.F.: MCT, 1997.<br>"
            },
            {
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "TOCKEY, S. Return on Software: Maximizing the Return on Your Software Investment, Addison-Wesley, 2004.<br>" +
                    "GRADY, S. O. The software paradox: the rise and fall of the commercial software market. O’Reilly, 2015.<br>" +
                    "SALIM, C. S. Construindo planos de negócios: todos os passos necessários para planejar e desenvolver negócios de sucesso. 3.a edição. Rio de Janeiro: Elsevier, 2005. ISBN 8535217363.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "BROOKS J., F. P. O mítico homem-mês: ensaios sobre engenharia de software. Elsevier, 2009. ISBN 9788535234879.<br>" +
                    "ENGHOLM J. H. Engenharia de software na prática. São Paulo: Novatec, 2010. ISBN 9788575222171.<br>" +
                    "PIMENTEL, L. O. A proteção jurídica da propriedade intelectual de software: noções básicas e temas relacionados. IEL, 2008. ISBN 9788587683045.<br>" +
                    "ORRICO J, H. Pirataria de Software. MM Livros, 2004. ISBN 8590424219.<br>" +
                    "LINS, B. F. E. et al. O mercado de software no Brasil: problemas institucionais e fiscais Brasília (DF): Câmara dos Deputados, Coordenação de Publicações, 2007. ISBN 9788573654998.<br>"
            },
            {
                ...
                "body": {
                    ...
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Não",
                    "theme8": "<b>Pré-requisito</b> <br>Programação Orientada a Objetos",
                },
                "subtitle": "Ementa",
                ...
                "subtitle2": "Bibliografia Básica",
                "bibliografia": "ANDREWS, G. R. Foundations of multithreaded, parallel, and distributed programming. Addison-Wesley, 2000.<br>" +
                    "COULOURIS, G. F. et al. Distributed Systems: Concepts and Design, 5th edition, Addison-Wesley, 2012.<br>" +
                    "KUROSE, J. F.; ROSS, K. Redes de Computadores e a Internet, 6.a edição. Pearson Education, 2013.<br>" +
                    "<br>Bibliografia complementar<br><br>" +
                    "BIRMAN, K. P. Reliable distributed systems: technologies, web services, and applications, New York: Springer, 2005. ISBN 0387215093.<br>" +
                    "CLARK, M. et al. Web services business strategies and architectures. Expert Press, 2002. ISBN 1904284132.<br>" +
                    "JOSUTTIS, N. M. SOA in practice. O'Reilly, 2007. ISBN 0596529554.<br>" +
                    "LYNCH, N. A Distributed algorithms. M. Kaufmann, 1997.<br>" +
                    "TANENBAUM, A.S.; STEEN, M. van. Distributed Systems: Principles and Paradigms. Prentice Hall, 2nd Edition, 2006.<br>"
            }
        ], // Fecha o Oitavo
        [  // Nono Semestre
            {
                ...
                "body": {
                    "theme1": "<b>Núcleo</b> <br>NC",
                    "theme2": "<b>Carga horária</b> <br>320",
                    "theme3": "<b>Teórica</b> <br>0",
                    "theme4": "<b>Prática</b> <br>320",
                    "theme5": "<b>Período</b> <br>9º",
                    "theme6": "<b>Unidade</b> <br>INF",
                    "theme7": "<b>Obrigatória</b> <br>Sim",
                    "theme8": "<b>Pré-requisito</b> <br>Nenhum",
                },
